...
export const WORLD_RECIPES: WorldRecipe[] = [
  ...
  // ── MÉXICO ────────────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🍈',
    titleEs: 'Papaya con limón suave',
    titleEn: 'Papaya with mild lime',
    ...
    stepsEs: [
      'Papaya muy madura pelada y sin semillas',
      'Cortar en tiras largas para BLW o machacar para purés',
      'Unas gotitas de limón sin sal — solo para dar sabor suave',
    ],
    stepsEn: [
      'Very ripe papaya, peeled and seeded',
      'Cut in long strips for BLW or mash for purées',
      'A few drops of lime — no salt, just mild flavor',
    ],
  ...
  },
  {
    ...
    stepsEs: [
      'Frijoles negros cocidos sin sal, aplastados con tenedor',
      'Si están muy espesos agregar agua de cocción',
      'BLW: formar pequeñas bolitas aplastadas en la bandeja',
    ],
    stepsEn: [
      'Cooked black beans without salt, mashed with fork',
      'If too thick add cooking water',
  ...
  {
    id: 'mx-calabaza-canela',
    country: 'mexico',
    fromMonths: 6,
    emoji: '🎃',
    titleEs: 'Puré de calabaza con canela',
    titleEn: 'Pumpkin purée with cinnamon',
    ...
    stepsEs: [
      'Calabaza en trozos al vapor 20 min o al horno 25 min',
      'Machacar hasta textura muy suave',
      'Agregar una pizca de canela — sin azúcar ni sal',
    ],
    stepsEn: [
      'Pumpkin pieces steamed 20 min or baked 25 min',
      'Mash to very smooth texture',
      'Add a pinch of cinnamon — no sugar or salt',
    ],
  ...
  {
    id: 'mx-aguacate-tortilla',
    country: 'mexico',
    fromMonths: 8,
    emoji: '🥑',
    titleEs: 'Aguacate en tortilla suave',
    titleEn: 'Avocado on soft tortilla',
    ...
    stepsEs: [
      'Tortilla de maíz calentada y cortada en tiras',
      'Aguacate maduro aplastado encima',
      'Servir doblada como taquito suave',
    ],
    stepsEn: [
      'Warm corn tortilla cut into strips',
      'Mashed ripe avocado on top',
      'Serve folded as a soft little taco',
    ],
  ...
  // ── INDIA ─────────────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🍚',
    titleEs: 'Khichdi de arroz y lentejas',
    titleEn: 'Rice and lentil khichdi',
    ...
    stepsEs: [
      'Arroz y lentejas rojas en proporción 1:1, enjuagados',
      'Cocinar con 4 partes de agua 20–25 min hasta muy suave',
      'Mixear hasta papilla o dejar con textura para BLW',
    ],
    stepsEn: [
      'Rice and red lentils 1:1 ratio, rinsed',
      'Cook with 4 parts water 20–25 min until very soft',
      'Blend to porridge or leave textured for BLW',
    ],
  ...
  {
    id: 'in-sweet-potato-dal',
    country: 'india',
    fromMonths: 6,
    emoji: '🍠',
    titleEs: 'Dal de batata y lentejas',
    titleEn: 'Sweet potato and lentil dal',
    ...
    stepsEs: [
      'Lentejas rojas cocidas 20 min',
      'Batata al vapor 15 min, aplastada',
      'Mezclar con una pizca de cúrcuma — sin sal',
    ],
    stepsEn: [
      'Red lentils cooked 20 min',
      'Sweet potato steamed 15 min, mashed',
      'Mix with a pinch of turmeric — no salt',
    ],
  ...
  {
    id: 'in-banana-cardamom',
    country: 'india',
    fromMonths: 6,
    emoji: '🍌',
    titleEs: 'Banana con cardamomo',
    titleEn: 'Banana with cardamom',
    ...
    stepsEs: [
      'Banana madura aplastada con tenedor',
      'Una pizca muy pequeña de cardamomo en polvo',
      'Mezclar bien y servir a temperatura ambiente',
    ],
    stepsEn: [
      'Ripe banana mashed with fork',
  ...
  },
  {
    ...
    fromMonths: 8,
    emoji: '🥣',
    titleEs: 'Papilla de tapioca (Sabudana)',
    titleEn: 'Tapioca porridge (Sabudana)',
    ...
    stepsEs: [
      'Tapioca remojada 4 horas, enjuagada',
      'Cocinar en agua 10 min hasta transparente y suave',
      'Agregar leche materna para cremosidad',
    ],
    stepsEn: [
      'Tapioca soaked 4 hours, rinsed',
      'Cook in water 10 min until transparent and soft',
      'Add breast milk for creaminess',
    ],
  ...
  // ── REINO UNIDO ───────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🥣',
    titleEs: 'Porridge de avena con pera',
    titleEn: 'Oat porridge with pear',
    ...
    stepsEs: [
      'Avena fina cocida con agua o leche materna 5 min',
      'Pera pelada al vapor 8 min y aplastada',
      'Mezclar las dos preparaciones',
    ],
    stepsEn: [
      'Fine oats cooked with water or breast milk 5 min',
      'Peeled pear steamed 8 min and mashed',
      'Mix both preparations together',
    ],
  ...
  },
  {
    ...
    fromMonths: 6,
    emoji: '🥦',
    titleEs: 'Verduras asadas al horno',
    titleEn: 'Oven roasted vegetables',
    ...
    stepsEs: [
      'Zanahoria, calabaza y chirivía en trozos al horno 200°C 25 min',
      'Sin aceite ni sal para bebés — las verduras sueltan su jugo',
      'BLW: servir en trozos. Purés: triturar con agua de cocción',
    ],
    stepsEn: [
      'Carrot, squash and parsnip chunks in oven 200°C 25 min',
      'No oil or salt for babies — vegetables release their own juice',
      'BLW: serve in chunks. Purée: blend with cooking water',
    ],
  ...
  },
  {
    ...
    fromMonths: 8,
    emoji: '🐟',
    titleEs: 'Fish pie de salmón y papa',
    titleEn: 'Salmon and potato fish pie',
    ...
    stepsEs: [
      'Salmón al vapor 10 min, desmenuzado sin piel ni espinas',
      'Papa cocida y aplastada con leche materna',
      'Mezclar suavemente — verificar que no haya espinas',
    ],
    stepsEn: [
      'Salmon steamed 10 min, flaked without skin or bones',
      'Potato cooked and mashed with breast milk',
      'Gently mix — double-check for bones',
    ],
  ...
  // ── ARGENTINA ─────────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🎃',
    titleEs: 'Puré de zapallo',
    titleEn: 'Pumpkin purée',
    ...
    stepsEs: [
      'Zapallo en trozos cocido al vapor 20 min o hervido',
      'Machacar con tenedor o mixear hasta textura deseada',
      'BLW: dejar en trozos blandos grandes',
    ],
    stepsEn: [
      'Pumpkin pieces steamed 20 min or boiled',
      'Mash with fork or blend to desired texture',
      'BLW: leave in large soft pieces',
    ],
  ...
  },
  {
    ...
    fromMonths: 6,
    emoji: '🥕',
    titleEs: 'Puré mixto de verduras',
    titleEn: 'Mixed vegetable purée',
    ...
    stepsEs: [
      'Papa, zanahoria y zapallo en trozos, hervidos 20 min',
      'Machacar juntos agregando agua de cocción',
      'Sin sal, sin manteca — los vegetales tienen suficiente sabor',
    ],
    stepsEn: [
      'Potato, carrot and pumpkin in pieces, boiled 20 min',
      'Mash together adding cooking water',
      'No salt, no butter — vegetables have enough flavor',
    ],
  ...
  },
  {
    ...
    fromMonths: 6,
    emoji: '🍗',
    titleEs: 'Pollo hervido desmechado',
    titleEn: 'Shredded boiled chicken',
    ...
    stepsEs: [
      'Pechuga de pollo hervida 25 min en agua sin sal',
      'Desmechar muy fino con dos tenedores',
      'Mezclar con el caldo de cocción para humedad',
    ],
    stepsEn: [
      'Chicken breast boiled 25 min in water without salt',
      'Shred very finely with two forks',
      'Mix with cooking broth for moisture',
    ],
  ...
  },
  {
    ...
    titleEn: 'Banana and oat porridge',
    ...
    stepsEs: [
      'Avena fina cocida con agua 5 min',
      'Banana madura aplastada y agregada al final',
      'Mezclar bien — la banana endulza naturalmente',
    ],
    stepsEn: [
      'Fine oats cooked with water 5 min',
      'Ripe banana mashed and added at the end',
      'Mix well — banana naturally sweetens',
    ],
  ...
  // ── ESPAÑA ────────────────────────────────────────────────────────────
  {
    id: 'es-crema-verduras',
    country: 'espana',
    fromMonths: 6,
    emoji: '🥦',
    titleEs: 'Crema de verduras española',
    titleEn: 'Spanish vegetable cream',
    ...
    stepsEs: [
      'Calabacín, zanahoria, judías verdes y puerro cocidos 20 min',
      'Mixear con agua de cocción hasta textura muy fina',
      'Sin sal — las verduras ya tienen sabor suficiente',
    ],
    stepsEn: [
      'Zucchini, carrot, green beans and leek cooked 20 min',
      'Blend with cooking water to very fine texture',
      'No salt — vegetables already have enough flavor',
    ],
  ...
  {
    id: 'es-papilla-cereales',
    country: 'espana',
    fromMonths: 6,
    emoji: '🥣',
    titleEs: 'Papilla de cereales con fruta',
    titleEn: 'Cereal porridge with fruit',
    ...
    stepsEs: [
      'Harina de arroz o maíz cocida con agua o leche materna',
      'Pera o manzana al vapor aplastada mezclada encima',
      'Consistencia líquida al inicio, ir espesando gradualmente',
    ],
    stepsEn: [
      'Rice or corn flour cooked with water or breast milk',
      'Steamed and mashed pear or apple mixed in',
      'Liquid consistency at start, gradually thickening',
    ],
  ...
  },
  {
    ...
    fromMonths: 8,
    emoji: '🐟',
    titleEs: 'Merluza al vapor con patata',
    titleEn: 'Steamed hake with potato',
    ...
    stepsEs: [
      'Merluza sin piel ni espinas al vapor 8 min',
      'Patata cocida aplastada con un poco de aceite de oliva',
      'Servir juntos — verificar siempre que no haya espinas',
    ],
    stepsEn: [
      'Skinless boneless hake steamed 8 min',
      'Cooked potato mashed with a little olive oil',
      'Serve together — always check for bones',
    ],
  ...
  // ── URUGUAY ───────────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🥕',
    titleEs: 'Puchero de verduras uruguayo',
    titleEn: 'Uruguayan vegetable puchero',
    ...
    stepsEs: [
      'Zanahoria, choclo, papa y zapallo hervidos 25 min en agua',
      'Separar las verduras y machacarlas con agua de cocción',
      'El caldo puede ofrecerse solo como bebida',
    ],
    stepsEn: [
      'Carrot, corn, potato and pumpkin boiled 25 min in water',
      'Separate vegetables and mash with cooking water',
      'The broth can be offered alone as a drink',
    ],
  ...
  {
    id: 'uy-batata-miel-prohibida',
    country: 'uruguay',
    fromMonths: 6,
    emoji: '🍠',
    titleEs: 'Batata asada uruguaya',
    titleEn: 'Uruguayan baked sweet potato',
    ...
    stepsEs: [
      'Batata entera al horno 180°C por 40 min hasta muy blanda',
      'Abrir y extraer la pulpa suave',
      'Sin miel (prohibida hasta 12 meses) — es naturalmente dulce',
    ],
    stepsEn: [
      'Whole sweet potato in oven 180°C for 40 min until very soft',
      'Open and scoop out the soft flesh',
      'No honey (forbidden until 12 months) — naturally sweet',
    ],
  ...
  {
    id: 'uy-arroz-con-leche-baby',
    country: 'uruguay',
    fromMonths: 8,
    emoji: '🍚',
    titleEs: 'Arroz cremoso con leche materna',
    titleEn: 'Creamy rice with breast milk',
    ...
    stepsEs: [
      'Arroz blanco cocido hasta muy suave con el triple de agua',
      'Agregar leche materna al final para cremosidad',
      'Opcionalmente una pizca muy pequeña de canela',
    ],
    stepsEn: [
      'White rice cooked very soft with triple the water',
      'Add breast milk at the end for creaminess',
      'Optionally a very small pinch of cinnamon',
    ],
  ...
  // ── CHILE ─────────────────────────────────────────────────────────────
  {
    ...
    fromMonths: 6,
    emoji: '🥔',
    titleEs: 'Puré chileno de papa y zanahoria',
    titleEn: 'Chilean potato and carrot purée',
    ...
    stepsEs: [
      'Papa y zanahoria peladas, cocidas 20 min hasta muy blandas',
      'Machacar juntas con agua de cocción sin sal',
      'Textura debe ser muy suave sin grumos',
    ],
    stepsEn: [
      'Peeled potato and carrot, cooked 20 min until very soft',
      'Mash together with cooking water without salt',
      'Texture should be very smooth without lumps',
    ],
  ...
  },
  {
    ...
    fromMonths: 6,
    emoji: '🍲',
    titleEs: 'Cazuela de verduras para bebé',
    titleEn: 'Baby vegetable cazuela',
    ...
    stepsEs: [
      'Zapallo, choclo, papa y zanahoria en caldo de agua sin sal',
      'Hervir 25 min — las verduras absorben el sabor del choclo',
      'Triturar o servir en trozos según el método',
    ],
    stepsEn: [
      'Pumpkin, corn, potato and carrot in unsalted water broth',
      'Boil 25 min — vegetables absorb the corn flavor',
      'Blend or serve in pieces depending on method',
    ],
  ...
  },
  {
    ...
    fromMonths: 8,
    emoji: '🐟',
    titleEs: 'Salmón del sur al vapor con papas',
    titleEn: 'Southern-style steamed salmon with potatoes',
    ...
    stepsEs: [
      'Filete de salmón fresco al vapor 10 min sin piel ni espinas',
      'Papa cocida y aplastada suavemente',
      'Desmenuzar el salmón en láminas grandes verificando espinas',
    ],
    stepsEn: [
      'Fresh salmon fillet steamed 10 min without skin or bones',
      'Potato gently cooked and mashed',
      'Flake salmon into large pieces checking for bones',
    ],
